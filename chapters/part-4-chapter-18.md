...
績效管理，基本上是種管理系統。這句話看起來很直白，而通常我們會用另一個字眼："績效評估"來掩蓋了績效管理的重點。即使量化的評估對於公眾服務水準的效率評估仍是核心，但績效管理的本質是行動導向的。也正是這些持續進行的定期管理檢討才能帶出新措施、資源重分配、服務流程或政策的修正、和所有其他改善我們政府服務的任何行動。
